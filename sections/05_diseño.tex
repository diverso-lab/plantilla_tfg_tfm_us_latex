...
\ph{Por ejemplo, una relación de uno a muchos:}
...
\begin{table}[h]
    ...
    \begin{tabular}{lll}
        ...
        \ph{campo\_2} & \ph{Tipo} & \ph{\dots} \\
        \ph{campo\_3} & \ph{Tipo} & \ph{\dots} \\ \hline
    \end{tabular}
...
\textbf{\ph{Entrada}} $\rightarrow$ \textbf{\ph{Representación intermedia}}
$\rightarrow$ \textbf{\ph{Artefacto final}}.}
...
\begin{itemize}
  \item \ph{\texttt{símbolo\_a}} $\rightarrow$ \ph{\texttt{valor\_a}}
  \item \ph{\texttt{símbolo\_b}} $\rightarrow$ \ph{\texttt{valor\_b}}
\end{itemize}
