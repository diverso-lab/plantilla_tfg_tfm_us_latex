...
\begin{longtable}{P{1.7cm} P{3.6cm} P{7.2cm} P{1.3cm}}
\toprule
...
funcionales y deben poder verificarse.}
...
\midrule
\endhead
RNF-01 & \ph{Nombre del RNF} & \ph{Atributo de seguridad/rendimiento/calidad y cómo se verifica.} & \ph{Alta} \\[0.4em]
RNF-02 & \ph{Nombre del RNF} & \ph{Atributo de seguridad/rendimiento/calidad y cómo se verifica.} & \ph{Alta} \\[0.4em]
RNF-03 & \ph{Nombre del RNF} & \ph{Atributo de seguridad/rendimiento/calidad y cómo se verifica.} & \ph{Media} \\[0.4em]
\midrule
RNF-04 & \ph{Nombre del RNF} & \ph{Atributo de seguridad/rendimiento/calidad y cómo se verifica.} & \ph{Alta} \\[0.4em]
RNF-05 & \ph{Nombre del RNF} & \ph{Atributo de seguridad/rendimiento/calidad y cómo se verifica.} & \ph{Media} \\
\bottomrule
